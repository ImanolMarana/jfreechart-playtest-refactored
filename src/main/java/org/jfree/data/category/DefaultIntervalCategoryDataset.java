...
public class DefaultIntervalCategoryDataset extends AbstractSeriesDataset
    ...
    public DefaultIntervalCategoryDataset(Comparable[] seriesKeys,
        ...
        if (starts != null && ends != null) {
            ...
            if (seriesCount > 0) {
                initializeSeriesKeys(seriesKeys, seriesCount);
                initializeCategoryKeys(starts, ends, categoryKeys);
            }
            else {
    ...
    private void initializeSeriesKeys(Comparable[] seriesKeys, int seriesCount) {
    ...
    private void initializeCategoryKeys(Number[][] starts, Number[][] ends,
