...
public class JSONUtils {
    ...
    public static void writeKeyedValues2D(KeyedValues2D data, Writer writer) 
        ...
        writer.write("{");
        writeColumnKeys(writer, columnKeys);
        writeRows(writer, data, columnKeys, rowKeys);
        writer.write("}");
    }

    private static void writeColumnKeys(Writer writer, List<Comparable<?>> columnKeys) throws IOException {
    ...
    private static void writeRows(Writer writer, KeyedValues2D data, List<Comparable<?>> columnKeys,
                                  List<Comparable<?>> rowKeys) throws IOException {
        if (!rowKeys.isEmpty()) {
            writer.write(", \"rows\": [");
