...
public class LogarithmicAxis extends NumberAxis {
    ...
    public void autoAdjustRange() {
        ...
        if (plot instanceof ValueAxisPlot) {
            ...
            upper = adjustUpperBound(upper, lower);

            // ensure the autorange is at least <minRange> in size...
            Range adjusted = adjustAutorange(lower, upper);
            setRange(adjusted, false, false);
            setupSmallLogFlag();       //setup flag based on bounds values
        }
    }

    private double adjustLowerBound(double lower) {
    ...
    private double adjustUpperBound(double upper, double lower) {
    ...
    private Range adjustAutorange(double lower, double upper) {
