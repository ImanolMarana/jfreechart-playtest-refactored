...
public class CategoryAxis extends Axis implements Cloneable, Serializable {
    ...
    protected AxisState drawCategoryLabels(Graphics2D g2, Rectangle2D plotArea,
        ...
        for (Object o : ticks) {
            ...
            state = drawCategoryLabel(g2, dataArea, edge, state,
                    categoryIndex, ticks.size(), tick, plotState);
            categoryIndex++;
        }
    ...
    private AxisState drawCategoryLabel(Graphics2D g2, Rectangle2D dataArea,
            RectangleEdge edge, AxisState state, int categoryIndex,
            int categoryCount, CategoryTick tick, PlotRenderingInfo plotState) {
