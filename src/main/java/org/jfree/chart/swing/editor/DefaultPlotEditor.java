...
//
    ...
    public void updatePlotProperties(Plot plot) {
        updatePlotAppearance(plot);
        updateAxisProperties(plot);
        updatePlotOrientation(plot);
        updateDrawLinesProperty(plot);
        updateDrawShapesProperty(plot);
      }
      
      private void updatePlotAppearance(Plot plot) {
      ...
      private void updateAxisProperties(Plot plot) {
        if (this.domainAxisPropertyPanel != null) {
          Axis domainAxis = getDomainAxis(plot);
          if (domainAxis != null) {
        ...
        if (this.rangeAxisPropertyPanel != null) {
          Axis rangeAxis = getRangeAxis(plot);
          if (rangeAxis != null) {
      ...
      private Axis getDomainAxis(Plot plot) {
        if (plot instanceof CategoryPlot) {
      ...
      private Axis getRangeAxis(Plot plot) {
        if (plot instanceof CategoryPlot) {
          return ((CategoryPlot) plot).getRangeAxis();
        } else if (plot instanceof XYPlot) {
          return ((XYPlot) plot).getRangeAxis();
        } else if (plot instanceof PolarPlot) {
          return ((PolarPlot) plot).getAxis();
        }
        return null;
      }
      
      private void updatePlotOrientation(Plot plot) {
        if (this.plotOrientation != null) {
          if (plot instanceof CategoryPlot) {
      ...
      private void updateDrawLinesProperty(Plot plot) {
        if (this.drawLines != null) {
          if (plot instanceof CategoryPlot) {
      ...
      private void updateDrawShapesProperty(Plot plot) {
        if (this.drawShapes != null) {
          if (plot instanceof CategoryPlot) {
            CategoryItemRenderer r = ((CategoryPlot) plot).getRenderer();
            if (r instanceof LineAndShapeRenderer) {
