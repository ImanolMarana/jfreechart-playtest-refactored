...
public class SerialUtils {
    ...
    public static Shape readShape(ObjectInputStream stream)
          ...
          if (!isNull) {
              Class c = (Class) stream.readObject();
              result = readShapeForClass(stream, c);
          }
          return result;

      }

      private static Shape readShapeForClass(ObjectInputStream stream, Class c) throws IOException, ClassNotFoundException {
          Shape result = null;
      ...
      private static Shape readGeneralPath(ObjectInputStream stream) throws IOException {
