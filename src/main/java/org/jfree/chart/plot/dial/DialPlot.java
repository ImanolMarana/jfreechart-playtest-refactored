...
public class DialPlot extends Plot implements DialLayerChangeListener {
    ...
    public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor,
        ...
        drawBackground(g2, frame, area);

        drawLayers(g2, frame, area);

        // draw the pointers
        drawPointers(g2, frame, area);

        drawCap(g2, frame, area);
    ...
    private void drawBackground(Graphics2D g2, Rectangle2D frame, Rectangle2D area) {
    ...
    private void drawLayers(Graphics2D g2, Rectangle2D frame, Rectangle2D area) {
    ...
    private void drawPointers(Graphics2D g2, Rectangle2D frame, Rectangle2D area) {
    ...
    private void drawCap(Graphics2D g2, Rectangle2D frame, Rectangle2D area) {
