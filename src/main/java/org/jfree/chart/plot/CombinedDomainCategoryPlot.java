...
public class CombinedDomainCategoryPlot extends CategoryPlot
    ...
    protected AxisSpace calculateAxisSpace(Graphics2D g2,
          ...
          space = calculateSubplotSpace(g2, adjustedPlotArea, space);

          return space;
      }

      private AxisSpace calculateSubplotSpace(Graphics2D g2, 
              Rectangle2D adjustedPlotArea, AxisSpace space) {
