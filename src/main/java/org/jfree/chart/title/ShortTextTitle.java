...
public class ShortTextTitle extends TextTitle {
    ...
    Size2D contentSize = calculateContentSize(g2, cc, w, h);
  ...
  private Size2D calculateContentSize(Graphics2D g2, RectangleConstraint cc, 
      LengthConstraintType w, LengthConstraintType h) {
    if (w == LengthConstraintType.NONE) {
      return calculateContentSizeForNoWidth(g2, h, cc);
    } else if (w == LengthConstraintType.RANGE) {
      return calculateContentSizeForRangeWidth(g2, h, cc);
    } else if (w == LengthConstraintType.FIXED) {
      return calculateContentSizeForFixedWidth(g2, h, cc);
    } else {
      return null;
    }
  }

  private Size2D calculateContentSizeForNoWidth(Graphics2D g2, 
      LengthConstraintType h, RectangleConstraint cc) {
  ...
  private Size2D calculateContentSizeForRangeWidth(Graphics2D g2, 
      LengthConstraintType h, RectangleConstraint cc) {
    if (h == LengthConstraintType.NONE) {
      return arrangeRN(g2, cc.getWidthRange());
    } else if (h == LengthConstraintType.RANGE) {
      return arrangeRR(g2, cc.getWidthRange(),
          cc.getHeightRange());
    } else if (h == LengthConstraintType.FIXED) {
      throw new RuntimeException("Not yet implemented.");
    } else {
  ...
  private Size2D calculateContentSizeForFixedWidth(Graphics2D g2, 
      LengthConstraintType h, RectangleConstraint cc) {
    if (h == LengthConstraintType.NONE) {
      return arrangeFN(g2, cc.getWidth());
    } else if (h == LengthConstraintType.RANGE) {
      throw new RuntimeException("Not yet implemented.");
    } else if (h == LengthConstraintType.FIXED) {
      throw new RuntimeException("Not yet implemented.");
