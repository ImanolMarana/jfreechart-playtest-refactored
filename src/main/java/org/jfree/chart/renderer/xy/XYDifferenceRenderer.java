...
public class XYDifferenceRenderer extends AbstractXYItemRenderer
    ...
    private void createPolygon (Graphics2D x_graphics,
        ...
        if (PlotOrientation.VERTICAL == l_orientation) {
          drawVerticalPolygon(x_graphics, x_dataArea, x_domainAxis,
                  x_rangeAxis, l_domainAxisLocation, l_rangeAxisLocation,
                  l_xValues, l_yValues, l_path);
        }
        else {
          drawHorizontalPolygon(x_graphics, x_dataArea, x_domainAxis,
                  x_rangeAxis, l_domainAxisLocation, l_rangeAxisLocation,
                  l_xValues, l_yValues, l_path);
        }
      ...
      private void drawVerticalPolygon(Graphics2D x_graphics,
                                       Rectangle2D x_dataArea,
                                       ValueAxis x_domainAxis,
                                       ValueAxis x_rangeAxis,
                                       RectangleEdge l_domainAxisLocation,
                                       RectangleEdge l_rangeAxisLocation,
                                       Object[] l_xValues, Object[] l_yValues,
                                       GeneralPath l_path) {
      ...
      private void drawHorizontalPolygon(Graphics2D x_graphics,
                                         Rectangle2D x_dataArea,
                                         ValueAxis x_domainAxis,
                                         ValueAxis x_rangeAxis,
                                         RectangleEdge l_domainAxisLocation,
