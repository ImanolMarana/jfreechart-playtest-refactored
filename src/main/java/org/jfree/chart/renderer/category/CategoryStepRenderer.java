...
public class CategoryStepRenderer extends AbstractCategoryItemRenderer
    ...
    public void drawItem(Graphics2D g2, CategoryItemRendererState state,
        ...
        if (column != 0) {
            ...
            if (previousValue != null) {
                drawPreviousDataPoint(g2, (State) state, orientation, 
                        dataArea, plot, domainAxis, rangeAxis, row, column, 
    ...
    private void drawPreviousDataPoint(Graphics2D g2, State state,
            PlotOrientation orientation, Rectangle2D dataArea,
            CategoryPlot plot, CategoryAxis domainAxis, ValueAxis rangeAxis,
            int row, int column, double previous) {
        // previous data point...
        ...
        if (getStagger()) {
            ...
            if (xStagger > (x0e - x0s)) {
                xStagger = (int) (x0e - x0s);
            }
            x0e = x0s + xStagger;
        }
        drawLine(g2, state, orientation, x0e, y0, x0e, y0);
