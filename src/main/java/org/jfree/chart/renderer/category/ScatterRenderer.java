...
public class ScatterRenderer extends AbstractCategoryItemRenderer
    ...
    public void drawItem(Graphics2D g2, CategoryItemRendererState state,
        ...
        for (int i = 0; i < valueCount; i++) {
            drawValuePoint(g2, state, dataArea, plot, domainAxis, 
                    rangeAxis, row, column, visibleRow, orientation, values, i);
        }

    }
    
    private void drawValuePoint(Graphics2D g2, CategoryItemRendererState state,
            Rectangle2D dataArea, CategoryPlot plot, CategoryAxis domainAxis,
            ValueAxis rangeAxis, int row, int column, int visibleRow,
            PlotOrientation orientation, List values, int i) {
        
        double x1 = calculateX(dataArea, plot, domainAxis, column, visibleRow, state);
        ...
        drawAndFillShape(g2, row, column, shape);
    }
    
    private double calculateX(Rectangle2D dataArea, CategoryPlot plot, 
            CategoryAxis domainAxis, int column, int visibleRow,
            CategoryItemRendererState state) {
        if (this.useSeriesOffset) {
            return domainAxis.getCategorySeriesMiddle(column,
                    getColumnCount(), visibleRow, state.getVisibleSeriesCount(),
    ...
    private void drawAndFillShape(Graphics2D g2, int row, int column, Shape shape) {
