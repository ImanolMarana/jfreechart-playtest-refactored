...
public class MinMaxCategoryRenderer extends AbstractCategoryItemRenderer {
    ...
    public void drawItem(Graphics2D g2, CategoryItemRendererState state,
        ...
        if (value != null) {
            ...
            drawObjectIcon(g2, plot.getOrientation(), x1, y1);

            updateMinMaxValues(dataset, row, column, value.doubleValue());

            drawMinMaxMarkers(g2, plot, dataArea, rangeAxis, x1, row, dataset);

            drawConnectingLine(g2, plot, dataset, dataArea, domainAxis, rangeAxis, row, column, x1, y1);
    ...
    private void drawObjectIcon(Graphics2D g2, PlotOrientation orient, double x1, double y1) {
    ...
    private void updateMinMaxValues(CategoryDataset dataset, int row, int column, double value) {
    ...
    private void drawMinMaxMarkers(Graphics2D g2, CategoryPlot plot, Rectangle2D dataArea, ValueAxis rangeAxis, double x1, int row, CategoryDataset dataset) {
    ...
    private void drawConnectingLine(Graphics2D g2, CategoryPlot plot, CategoryDataset dataset, Rectangle2D dataArea, CategoryAxis domainAxis, ValueAxis rangeAxis, int row, int column, double x1, double y1) {
