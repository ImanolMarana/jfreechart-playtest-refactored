...
public class DefaultPolarItemRenderer extends AbstractRenderer
    ...
    public void drawSeries(Graphics2D g2, Rectangle2D dataArea,
          ...
          GeneralPath poly = createPolygon(plot, dataset, dataArea, seriesIndex,
                  numPoints);

          drawPolygon(g2, info, plot, dataset, seriesIndex, poly);
      }

      private GeneralPath createPolygon(PolarPlot plot, XYDataset dataset,
              Rectangle2D dataArea, int seriesIndex, int numPoints) {
      ...
      private void drawPolygon(Graphics2D g2, PlotRenderingInfo info,
          ...
          if (this.shapesVisible) {
              drawItemShapes(g2, info, dataArea, dataset, seriesIndex, poly);
          }
      }

      private void drawItemShapes(Graphics2D g2, PlotRenderingInfo info,
              Rectangle2D dataArea, XYDataset dataset, int seriesIndex,
              GeneralPath poly) {
